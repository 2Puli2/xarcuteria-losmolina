...
export const CAT = {
  ...
  // Els preus estan a src/app/views/carta/carta-data.ts (única font de veritat).
  // NOTA: Tots els items PODEN tenir una propietat 'desc' amb la descripció.
  // Exemple: { name: 'Pernil Ibèric', desc: 'Pernil 100% de gla, criat a la devesa' }
  cartaItems: {
    aperitivos: {
    ...
    embutidoItems: {
      ...
      atun:                    { name: 'Tonyina' },
      cantabrico:              { name: 'Cantàbric', desc: 'Seitons, olives, piment vermell i tonyina.' },
