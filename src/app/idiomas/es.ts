...
export const ES = {
  ...
  // Los precios están en src/app/views/carta/carta-data.ts (única fuente de verdad).
  // NOTA: Todos los items PUEDEN tener una propiedad 'desc' con la descripción.
  // Ejemplo: { name: 'Jamón Ibérico', desc: 'Jamón 100% de bellota, criado en montanera' }
  cartaItems: {
    aperitivos: {
    ...
    menus: {
      menu_iberico:      { name: 'Menú Ibérico', desc: 'Ración de paletilla ibérica, ración de queso semicurado, pan con tomate y 2 bebidas' },
      menu_bellota:      { name: 'Menú Bellota', desc: 'Ración de paletilla de bellota, ración de queso curado, pan con tomate y 2 bebidas' },
      menu_delicatessen: { name: 'Menú Delicatessen', desc: 'Ración de jamón Cinco Jotas, ración de queso Payoyo curado y semicurado, pan con tomate y 2 bebidas' },
    },
    embutidoGroupTitles: {
      jamon:              'Jamón',
