...
export const EN = {
  ...
  // Prices are in src/app/views/carta/carta-data.ts (single source of truth).
  // NOTE: All items CAN have a 'desc' property with the description.
  // Example: { name: 'Iberian Ham', desc: '100% acorn-fed ham, raised in dehesa' }
  cartaItems: {
    aperitivos: {
      ...
      surtido_pates:    { name: 'Assorted Pâtés', desc: 'With jam and toast' },
