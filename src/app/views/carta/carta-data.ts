 ...
 * │  Para añadir descripción: añade `desc: "..."` en los archivos de idioma   │
 * │  en la propiedad del item. Ejemplo:                                       │
 * │    { name: 'Producto', desc: 'Mi descripción aquí' }                      │
 * └───────────────────────────────────────────────────────────────────────────┘
 *
...
export const EMBUTIDO_GROUPS_PRICES: EmbutidoPriceGroup[] = [
    {
        ...
        items: [
            ...
            { key: 'iberico_cebo_mano',      medioBocadillo: '6,50', bocadilloEntero: '10,40', torrada: '12,00', mediaTabla: '7,50',  tabla: '15,00' },
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'salchichon_joselito',       medioBocadillo: '6,50', bocadilloEntero: '10,40',  torrada: '12,50', mediaTabla: '10,50', tabla: '19,50'  },
            { key: 'lomo_iberico',              medioBocadillo: '4,10', bocadilloEntero: '8,20',  torrada: '9,50', mediaTabla: '5,50', tabla: '11,00'   },
            { key: 'lomo_bellota',              medioBocadillo: '4,90', bocadilloEntero: '9,80',  torrada: '11,50', mediaTabla: '6,00', tabla: '12,00'   },
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'catalana_can_duran',    medioBocadillo: '2,90', bocadilloEntero: '5,80', torrada: '7,50', mediaTabla: '5,00', tabla: '9,00'      },
            { key: 'catalana_trufada',      medioBocadillo: '3,50', bocadilloEntero: '7,00', torrada: '9,50', mediaTabla: '6,00', tabla: '11,00'     },
            { key: 'pechuga_pavo_natural',  medioBocadillo: '2,90', bocadilloEntero: '5,80', torrada: '7,50', mediaTabla: '5,00', tabla: '9,00'      },
            { key: 'pechuga_pavo_braseada', medioBocadillo: '2,90', bocadilloEntero: '5,80', torrada: '7,50', mediaTabla: '5,00', tabla: '9,00'      },
            { key: 'cecina',                medioBocadillo: '4,50', bocadilloEntero: '9,00', torrada: '12,00',mediaTabla: '5,00', tabla: '9,00'      },
            { key: 'fuet',                  medioBocadillo: '2,90', bocadilloEntero: '5,80', torrada: '7,50'                                         },
            { key: 'longaniza_vic',         medioBocadillo: '2,90', bocadilloEntero: '5,80', torrada: '8,00'                                         },
    ...
    },
    {
        groupKey: 'quesos',
        items: [
            { key: 'queso_semicurado',   medioBocadillo: '2,90', bocadilloEntero: '5,40',  torrada: '7,50', mediaTabla: '5,00',  tabla: '9,00'   },
            { key: 'queso_curado',       medioBocadillo: '3,40', bocadilloEntero: '5,80',  torrada: '7,50', mediaTabla: '5,00',  tabla: '9,00'   },
