...
export const REFRESCOS_DATA: BebidaItem[] = [
    { key: 'agua_veri_033',       name: 'Agua Veri 0,33L',                             price: '1,60' },
    { key: 'agua_veri_05',        name: 'Agua Veri 0,5L',                              price: '1,80' },
    { key: 'agua_veri_15',        name: 'Agua Veri 1,5L',                              price: '2,50' },
    { key: 'vichy_catalan',       name: 'Vichy Catalan',  desc: 'Agua con gas',        price: '2,60' },
    { key: 'zumo_naranja_pequeño', name: 'Zumo de Naranja Natural (pequeño)',           price: '2,90' },
    { key: 'zumo_naranja_grande', name: 'Zumo de Naranja Natural (grande)',             price: '5,00' },
    { key: 'zumo_variado',        name: 'Zumo', desc: 'Piña, melocotón o naranja',     price: '2,10' },
    { key: 'cacaolat',            name: 'Cacaolat',                                    price: '2,50' },
    { key: 'horchata_chufi',      name: 'Horchata Chufi',                              price: '2,50' },
    { key: 'coca_cola',           name: 'Coca-Cola',                                   price: '2,60' },
    { key: 'coca_cola_zero',      name: 'Coca-Cola Zero',                              price: '2,60' },
    { key: 'coca_cola_zero_zero', name: 'Coca-Cola Zero Zero',                         price: '2,60' },
    { key: 'fanta_limon',         name: 'Fanta Limón',                                 price: '2,60' },
    { key: 'fanta_naranja',       name: 'Fanta Naranja',                               price: '2,60' },
    { key: 'aquarius_limon',      name: 'Aquarius Limón',                              price: '2,60' },
    { key: 'fuze_tea',            name: 'Fuze Tea',                                    price: '2,60' },
    { key: 'sprite',              name: 'Sprite',                                      price: '2,60' },
    { key: 'tonica_nordic',       name: 'Tónica Nordic',                               price: '2,60' },
    { key: 'trina_naranja',       name: 'Trina Naranja',                               price: '2,60' },
    { key: 'trina_limon',         name: 'Trina Limón',                                 price: '2,60' },
    { key: 'bitter_kas',          name: 'Bitter Kas',                                  price: '2,60' },
];

export const CERVEZAS_DATA: BebidaItem[] = [
    { key: 'canya_cerveza',       name: 'Caña de cerveza',   price: '2,00' },
    { key: 'copa_cerveza',        name: 'Copa de cerveza',   price: '2,50' },
    { key: 'jarra_cerveza',       name: 'Jarra de cerveza',  price: '4,00' },
    { key: 'canya_clara',         name: 'Caña de clara',     price: '2,20' },
    { key: 'copa_clara',          name: 'Copa de clara',     price: '2,70' },
    { key: 'jarra_clara',         name: 'Jarra de clara',    price: '4,50' },
    { key: 'turia',               name: 'Turia',             price: '2,60' },
    { key: 'volldam',             name: 'Volldam',           price: '2,80' },
    { key: 'complot_ipa',         name: 'Complot IPA',       price: '3,00' },
    { key: 'free_damm',           name: 'Free Damm',         price: '2,60' },
    { key: 'free_damm_tostada',   name: 'Free Damm Tostada', price: '2,60' },
    { key: 'free_damm_lemon',     name: 'Free Damm Lemon',   price: '2,60' },
];

export const VINOS_DATA: BebidaItem[] = [
    { key: 'copa_vino_casa',        name: 'Copa de vino de la casa', desc: 'Tinto o blanco', price: '2,20' },
    { key: 'copa_vino_rioja',       name: 'Copa de vino Rioja',                              price: '2,70' },
    { key: 'copa_vino_ribera',      name: 'Copa de vino Ribera',                             price: '3,00' },
    { key: 'copa_vino_verdejo',     name: 'Copa de vino Verdejo',                            price: '2,80' },
    { key: 'copa_vino_albarino',    name: 'Copa de vino Albariño',                           price: '3,00' },
    { key: 'copa_cava_brut_nature', name: 'Copa de cava Brut Nature',                        price: '2,90' },
    { key: 'vermut_espinaler',      name: 'Vermut Espinaler', desc: 'Blanco o negro',        price: '2,90' },
    { key: 'tinto_de_verano',       name: 'Tinto de verano',                                 price: '3,50' },
];

export const CAFES_DATA: BebidaItem[] = [
    { key: 'solo',      name: 'Solo',      price: '1,50' },
    { key: 'cortado',   name: 'Cortado',   price: '1,60' },
    { key: 'con_leche', name: 'Con leche', price: '1,80' },
    { key: 'capuccino', name: 'Capuccino', price: '2,50' },
    { key: 'americano', name: 'Americano', price: '1,80' },
    { key: 'carajillo', name: 'Carajillo', price: '2,20' },
    { key: 'trifasico', name: 'Trifásico', price: '2,50' },
    { key: 'infusion',  name: 'Infusión',  price: '1,90' },
    { key: 'cola_cao',  name: 'Cola Cao',  price: '2,10' },
];
